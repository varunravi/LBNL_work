...
# THEREFORE the new data needs to be run probably like:
# python3 fits_to_npz_ajpilon.py output_empty_directory NEW_CLASSIFICATIONS.csv bands?

# THIS VERSION NEEDS TO BE MODIFIED FROM fits_to_npz.py TO PROCESS DATA FROM LEGACY SURVEY FITS CUTOUTS
